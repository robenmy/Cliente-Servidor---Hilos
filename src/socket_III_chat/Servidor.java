   ...
   ///el metodo que que siempre estara a la escucha estara aqui dentro
	...
	public void run() {
		...
		try {
			...
			//---- crear un socket por donde viaje la informacion hacia el destinatario
			
			Socket enviaDestinatario = new Socket(ip,9090); //puente por donde viajara la info
			
			ObjectOutputStream paqueteReenvio = new ObjectOutputStream(enviaDestinatario.getOutputStream());
			// ahora procedemos a meter la informacion a enviar por el objectOutputStream
